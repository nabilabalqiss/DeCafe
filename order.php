                ...
                <div class="row">
                  <div class="col-lg-3">
                    <div class="form-floating mb-3">
                      <input type="text" class="form-control" id="uploadFoto" name="kode_order" value="<?php echo date('ymdHi') . rand(100, 99) ?>" readonly>
                  ...
                  <div class="col-lg-2">
                    <div class="form-floating mb-3">
                      ...
                      <label for="meja">Nama Meja</label>
                      <div class="invalid-feedback">
                        Masukkan Meja.
                      </div>
                    </div>
            ...
            <tbody>
              ...
              ?>
                <tr>
                  ...
                  <td>
                    <div class="d-flex">
                      <a class="btn btn-info btn-sm me-1" href="./?x=orderitem&order=<?php echo $row['id_order'] . "&meja=" . $row['meja'] . "&pelanggan=" . $row['pelanggan'] ?>">

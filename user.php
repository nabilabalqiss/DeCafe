            ...
            <div class="modal-body">
              <form class="needs-validation" novalidate action="proses/proses_input_user.php" method="POST">
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-floating mb-3">
                      <input disable type="text" class="form-control" id="floatingInput" placeholder="Your Name"
                  ...
                  <div class="col-lg-6">
                    <div class="form-floating mb-3">
                      <input disable type="email" class="form-control" id="floatingInput" placeholder="name@example.com"
                ...
                <div class="row">
                  <div class="col-lg-4">
                    <div class="form-floating mb-3">
                      <select disabled class="form-select" aria-label="Default select example" required nama="level"
                        id="">
                        <?php
                  ...
                  <div class="col-lg-8">
                    <div class="form-floating mb-3">
                      <input disable type="number" class="form-control" id="floatingInput" placeholder="08xxxxx"
                ...
                <div class="form-floating">
                  <textarea disable class="form-control" id="" style="height:100px" name="alamat"
              ...
              <form class="needs-validation" novalidate action="proses/proses_delete_user.php" method="POST">
                ...
                <div class="modal-footer">
                  ...
                  <button type="submit" class="btn btn-danger" name="input_user_validate" value="12345"
                    <?php echo ($row['username'] == $_SESSION['username_decafe']) ? 'disabled' : '' ; ?>>Delete</button>
                </div>
            </div>
            </form>
          </div>

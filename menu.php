              ...
              <div class="modal-body">
                <form class="needs-validation" novalidate action="proses/proses_input_user.php" method="POST">
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-floating mb-3">
                        <input disable type="text" class="form-control" id="floatingInput" placeholder="Your Name" name="nama" value="<?php echo $row['nama'] ?>">
                    ...
                    <div class="col-lg-6">
                      <div class="form-floating mb-3">
                        <input disable type="email" class="form-control" id="floatingInput" placeholder="name@example.com" name="username" value="<?php echo $row['username'] ?>">
                  ...
                  <div class="row">
                    <div class="col-lg-4">
                      <div class="form-floating mb-3">
                        <select disabled class="form-select" aria-label="Default select example" required nama="level" id="">
                          <?php
                    ...
                    <div class="col-lg-8">
                      <div class="form-floating mb-3">
                        <input disable type="number" class="form-control" id="floatingInput" placeholder="08xxxxx" name="nohp" value="<?php echo $row['nohp'] ?>">
                  ...
                  <div class="form-floating">
                    <textarea disable class="form-control" id="" style="height:100px" name="alamat" value="<?php echo $row['alamat'] ?>"> </textarea>
